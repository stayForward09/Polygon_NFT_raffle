...
contract nft721Auction is Ownable, Pausable, ReentrancyGuard {
    // Events
    event AuctionCreated(uint256 itemId, address nftContract, uint256 tokenId, uint256 minPrice, uint256 startDate, uint256 endDate);
