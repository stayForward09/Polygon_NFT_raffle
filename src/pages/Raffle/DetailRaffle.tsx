...
import { buyTicket, fetchMyTickets, fetchRaffleItems, fetchTicketItemsByID } from "../../services/contracts/raffle";
...
const DetailRaffle = () => {
  ...
  const countdownEndRenderer = ({ api, days, hours, minutes, seconds, completed }: any) => {
    ...
    return (
      completed ?
        <p className="text-[18px] font-semibold" >{nftInfo.end_date ? ` ENDED` : `loading...`}</p>
        :
        <div className="flex gap-1 text-white text-[18px] font-semibold" >
          <p>Live</p>
          <p>
                  ...
                  <div className="flex flex-col gap-[16px] bg-white p-[18px] ">
                    ...
                    >
                      ...
                      <span className=" flex items-center gap-1 ml-3 text-lg">
                        <span>Price:</span>
                        <span className="font-medium" >{nftInfo.price} MATIC</span>
                        ...
                        <div className="flex items-center justify-between gap-[8px] ">
                          ...
                          >
                            <span className="text-center sm:text-lg text-sm text-white">
                              Buy for {(amount * nftInfo.price).toFixed(2)} MATIC
                            </span>
                  ...
                  <div className="bg-[#8652FF] rounded-[16px] py-4 px-4 sm:px-0 mt-4">
                    <div className="relative sm:flex block justify-between sm:w-[85%] m-auto">
                      ...
                      <div className={`
                        ...
                        <p className="text-white text-[18px] font-semibold ">{(nftInfo.total_tickets) ? nftInfo.total_tickets - currentBuyTicket : 0}/{nftInfo.total_tickets}</p>
                      </div>
                      <div className={`
